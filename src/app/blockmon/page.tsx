...
export default function BlockmonScanPage() {
  ...
  const [readingStatus, setReadingStatus] = useState<NFCReadingStatus>({
    status: "idle",
  });
  ...
  const startNfcScan = async () => {
    try {
      ...
      ndef.addEventListener(
        "reading",
        async ({ message }: { message: { records: NDEFRecord[] } }) => {
          try {
      ...
      setReadingStatus({
        status: "error",
        message:
          "Error starting NFC scan. Make sure NFC is enabled on your device.",
      });
    }
  };
          ...
          {nfcSupported === null ? (
            ...
            >
              ...
              <span className="block sm:inline">
                {" "}
                Your device or browser doesn&apos;t support NFC scanning. Please
                use a compatible device (like an Android phone with Chrome).
              </span>
            </div>
          ) : (
            <>
              <div className="text-center mb-8">
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Tap the button below and hold your Blockmon NFC card to the
                  back of your device to scan it.
                </p>
              ...
              <div className="mt-8 border-t pt-6">
                <h2 className="text-xl font-semibold mb-4">
                  How to scan your Blockmon card:
                </h2>
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Tap the &quot;Start NFC Scan&quot; button</li>
                  <li>
                    Hold your Blockmon NFC card to the back of your device
                  </li>
                  <li>Keep the card steady until scanning completes</li>
                  <li>
                    You&apos;ll be redirected to your Blockmon&apos;s details
                    page
                  </li>
                </ol>
              </div>
